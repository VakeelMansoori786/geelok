...
@Component({
  ...
  styleUrls: ['./payment-received-list.component.scss'],
    providers: [MessageService,ConfirmationService]
})
export class PaymentReceivedListComponent implements OnInit {
...
GetDetail(id:any){
  this.router.navigate(['/sales/payment-received',{ id: btoa(id) },]);

}

Add(){
  this.router.navigate(['/sales/payment-received']);
}
